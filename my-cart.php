...
{   
    ...
    $sql = "SELECT order_id from order_mst order by order_id desc limit 1";
    $result = mysqli_query($con, $sql);
    $row=mysqli_fetch_array($result);
    if($row['order_id'] >0){
        $number   = $row['order_id']+1;
    }
    else{
        $number   = 1;
    }
	...
	mysqli_query($con,"INSERT INTO `order_mst`( `order_code`) VALUES ('$unique_id')");
	...
	$query=mysqli_query($con,"update users set billingAddress='$baddress',billingState='$bstate',billingCity='$bcity',area='$area',billingPincode='$bpincode' where id='".$_SESSION['id']."'");
	if($query)
	{
...
<div class="form-group">
			 ...
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control unicase-form-control text-input" id="billingcity" name="billingcity"  value="<?php echo $row['billingCity'];?>" required>
					  </div>
					   ...
					   <div class="form-group">
					    ...
					    <input type="text" class="form-control unicase-form-control text-input" id="billingpincode" name="billingpincode" value="<?php echo $row['billingPincode'];?>" required>
					  </div>
					  </div>
