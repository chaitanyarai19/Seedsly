...
class MYPDF extends TCPDF {
	...
	public function Header() {
		// Logo
	$image_file = K_PATH_IMAGES.'1.jpg';
	$this->Image($image_file, 50, 30, 50, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
		// Set font
		$this->SetFont('helvetica', 'B', 20);
		// Title
		
		$this->Cell(180,10,'Seedsly',10, false, 'C', 0, '', 0, false, 'M', 'M');
		//$this->SetX(-15);
	}
// Page footer
...
<td width="100%" style="border: 1px solid #009efb;color:white;" align="center"><b>Seed Purchase BILL</b></td>
</tr>
...
orders.userId=users.id join products on products.id=orders.productId where orders.orderDate Between '$from' and '$to' and users.id=$user_id and orders.order_code='$order_code'");
									...
									while($row=mysqli_fetch_array($query))
									{
                                       ...
                                       $html.='<tr style="line-height:30px;">
											...
											<td style="border: 1px solid black;" width="20%" align="right">'.number_format($price,2).'</td>
										</tr>';
