...
<!-- Hero Section Begin -->
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            ...
            <div>
                <a href="#"><img data-u="image" src="img/slider/slider4.jpg" /></a>
            </div>
            <div>
            ...
            <div class="row">
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3" style="width:500px;height:300px;">
                        <div class="categories__item set-bg" data-setbg="img/highlights/hl1.jpg">
                            <h5><a href="#">BeetRoot</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3" style="width:500px;height:300px;">
                        <div class="categories__item set-bg" data-setbg="img/highlights/hl2.jpg">
                            <h5><a href="#">Cabbage</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3" style="width:500px;height:300px;">
                        <div class="categories__item set-bg" data-setbg="img/highlights/hl3.jpg">
                            <h5><a href="#">Broccoli</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3" style="width:500px;height:300px;">
                        <div class="categories__item set-bg" data-setbg="img/highlights/hl4.jpg">
                            <h5><a href="#">Bottle Gourd</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3" style="width:500px;height:300px;">
                         <div class="categories__item set-bg" data-setbg="img/highlights/hl5.jpg">
                            <h5><a href="#">Brinjal</a></h5>
                        </div>
                    </div>
                </div>
            </div>
